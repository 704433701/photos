...
@property (nonatomic, retain) CalculatorViewController *calculatorVC;
...
- (void)showInPwd
{
    ...
    if ([_user boolForKey:@"4"]) {
        
        // 从storyboard创建MainViewController
        //        UIStoryboard* storyboard = [UIStoryboard storyboardWithName:@"Main" bundle:[NSBundle mainBundle]];
        //        self.calculatorVC = (CalculatorViewController*)[storyboard instantiateViewControllerWithIdentifier:@"CalculatorViewController"];
        self.calculatorVC = [[CalculatorViewController alloc] init];
        [_mainVC presentViewController:_calculatorVC animated:NO completion:nil];
    }
}
