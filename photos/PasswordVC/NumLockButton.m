...
- (instancetype)initWithNumber:(NSUInteger)number letters:(NSString *)letters
{
    ...
    if (self)
    {
        ...
        [self setBackgroundImage:[UIImage imageNamed:@"wodehuodong"] forState:UIControlStateHighlighted];
//        self.backgroundColor = [UIColor blueColor];
        self.layer.cornerRadius = 64.0 / 2.0f;
        self.layer.borderWidth = 1.0f;
        self.layer.masksToBounds = YES;
        self.layer.borderColor = [[UIColor colorFromHexCode:@"#009ad6"]CGColor];
