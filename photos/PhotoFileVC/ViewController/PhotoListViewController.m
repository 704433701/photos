...
- (void)viewDidLoad {
    ...
    self.collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, WIDTH, HEIGHT - 50) collectionViewLayout:flowLayout];
    ...
    self.imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 64, WIDTH, HEIGHT - 50)];
    _imageView.image = [UIImage imageNamed:@"list_blank.png"];
    [self.view addSubview:_imageView];
    
    self.bannerView = [[GADBannerView alloc] initWithFrame:CGRectMake(0, HEIGHT - 50, WIDTH, 50)];
    [self.view addSubview:_bannerView];
    self.bannerView.adUnitID = @"ca-app-pub-8966387155740983/9707694958";
    self.bannerView.rootViewController = self;
    GADRequest *request = [GADRequest request];
    request.testDevices = @[ @"5b7ff3f172a0a3b0680edda64e54eb8a" ];
